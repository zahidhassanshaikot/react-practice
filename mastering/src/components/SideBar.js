          ...
          <span className="input-group-btn">
              ...
              <i className="fa fa-angle-left pull-right"></i>
                            ...
                            <ul className="treeview-menu">
                                <li className="active"><a href="index.html"><i className="fa fa-circle-o"></i> Dashboard
                                    v1</a></li>
              ...
              <i className="fa fa-angle-left pull-right"></i>
                            ...
                            <ul className="treeview-menu">
                                <li><a href="pages/charts/chartjs.html"><i className="fa fa-circle-o"></i> ChartJS</a>
                                </li>
              ...
              <i className="fa fa-angle-left pull-right"></i>
                            ...
                            <ul className="treeview-menu">
                                ...
                                <li><a href="pages/examples/404.html"><i className="fa fa-circle-o"></i> 404 Error</a>
                                </li>
                                <li><a href="pages/examples/500.html"><i className="fa fa-circle-o"></i> 500 Error</a>
                                </li>
